...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        q[4][0] = "What is the size of boolean variable?";
        q[4][1] = "8 bit";
        q[4][2] = "10 bit";
        q[4][3] = "16 bit";
        q[4][4] = "32 bit";
        ...
        q[6][0] = "Composition represents";
        q[6][1] = "HAS-A relationship.";
        q[6][2] = "IS-A relationship.";
        q[6][3] = "None of the above.";
        ...
        q[9][0] = "Which method must be implemented by all threads?";
        q[9][1] = "wait()";
        q[9][2] = "start()";
        q[9][3] = "stop()";
        q[9][4] = "run()";
        ...
        opt1.setBounds(148, 470, 700, 30);
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt1.setBackground(Color.WHITE);
        add(opt1);
        
        opt2 = new JRadioButton("");
        opt2.setBounds(148, 510, 700, 30);
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt2.setBackground(Color.WHITE);
        add(opt2);
        
        opt3 = new JRadioButton("");
        opt3.setBounds(148, 550, 700, 30);
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt3.setBackground(Color.WHITE);
        add(opt3);
        
        opt4 = new JRadioButton("");
        opt4.setBounds(148, 590, 700, 30);
        ...
        next.setBounds(1019, 467, 200, 40);
        add(next);
        ...
        lifeline.setBounds(1019, 535, 200, 40);
        ...
        submit.setBounds(1019, 602, 200, 40);
        add(submit);
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0) {
            g.drawString(time, 990, 464);
        }else {
            g.drawString("Times Up!!", 1070, 464);
        }
